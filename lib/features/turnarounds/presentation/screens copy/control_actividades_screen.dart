...
class _ComentarioView extends ConsumerWidget {
  ...
  Future<void> openComentarioInputDialog(BuildContext context, WidgetRef ref) async {
    final textController = TextEditingController(text: tarea.comentario ?? '');
    try {
      await showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: ComentarioDialogContent(textController: textController),
            actions: <Widget>[
              FilledButton(
                style: FilledButton.styleFrom(
                  backgroundColor: Colors.grey,
      ...
      children: [
        Row(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => openComentarioInputDialog(context, ref),
              style: ElevatedButton.styleFrom(
                shape: CircleBorder(),
                padding: EdgeInsets.all(5),
                fixedSize: const Size(45, 45),
        ...
        GestureDetector(
          onTap: () => openComentarioInputDialog(context, ref),
          child: Container(
            width: double.infinity,
            padding: const EdgeInsets.all(10),
            margin: const EdgeInsets.symmetric(vertical: 10),
