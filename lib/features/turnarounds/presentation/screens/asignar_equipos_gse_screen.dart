                          ...
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              width: MediaQuery.of(context)
                                  .size
                                  .width, // Allow the ListView to take max width
                              // CheckboxListTile(
                              //   title: Text(categoria.categoriaNombre),
                              //   value: categoria.,
                              //   onChanged: (value) {
                              //     // Change selected value
                              //     categoria.selected = value ?? false;
                              //     setState(() {});
                              //   },
                              // ),
                              child: ListView.builder(
                                shrinkWrap:
                                    true, // Important for ListView in AlertDialog
                                physics:
                                ...
                                itemBuilder: (BuildContext context, int indexMaquinaria) {
                                  ...
                                  //   onTap: () {
                                  //     // Change selected value
                                  //     maquinaria.selected = !maquinaria.selected;
                                  //     setState(() {});
                                  //   },
                                  //   trailing: Checkbox(
                                  //     value: maquinaria.selected,
          ...
          child: Row(
            ...
            children: [
              ...
              CustomFilledButton(
                ...
                onPressed: () async {
                  final idsMaquinariasNewState = _getMaquinariasIds(categorias);
