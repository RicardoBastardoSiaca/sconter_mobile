...
class AsignarServiciosEspecialesScreen extends ConsumerWidget {
  const AsignarServiciosEspecialesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(title: Text('Agregar Servicios Especiales')),
...
class _AsignarEquiposGseViewState
  ...
  void initState() {
    ...
    // print("******************************************");
    // print(
    //   "servicios especiales: ${ref.read(controlActividadesProvider(ref.read(selectedTurnaroundProvider)!.id)).controlActividades!.serviciosEspeciales!}",
    // );
