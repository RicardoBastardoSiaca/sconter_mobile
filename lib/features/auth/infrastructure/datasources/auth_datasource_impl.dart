...
class AuthDataSourceImpl extends AuthDataSource {
  ...
  Future<AuthResponse> checkAuthStatus(String token) async {
    ...
    try {
      final response = await dio.post('/usuarios/check_token/?token=$token', options: Options(headers: {'token': token}));
      final loginResponse = LoginResponseMapper.loginResponseJsonToEntity(response.data);
